...
#include "sim/graphics/compiledShaders/basic/sky/computeMultipleScattering_frag.h"
...
void SkyModel::computeMultipleScattering() {
  ...
  { // Pipeline
    ...
    pipelineMaker.shader(shader::eVertex, quad_vert, __ArraySize__(quad_vert))
      .shader(
        shader::eFragment, computeMultipleScattering_frag,
        __ArraySize__(computeMultipleScattering_frag));
