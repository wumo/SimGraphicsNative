...
void SkyModel::computeSingleScattering(
...

  {
    ...
    auto descriptorPool =
      device.getDevice().createDescriptorPoolUnique(descriptorPoolInfo);
    // Descriptor sets
    ...
    device.computeImmediately([&](vk::CommandBuffer cb) {
      ...
      {
        vk::ImageMemoryBarrier barrier{access::eShaderWrite,
                                       access::eShaderRead,
                                       layout::eGeneral,
                                       layout::eGeneral,
                                       ...
                                       deltaRayleighScatteringTexture.subresourceRange(
                                         vk::ImageAspectFlagBits::eColor)};
        cb.pipelineBarrier(
          stage::eComputeShader, stage::eAllCommands, {}, nullptr, nullptr, barrier);
      }
    });
  }
}
