...
layout(location = 3) out float outTessLevel;
layout(location = 4) out flat uint outMaterialID;
layout(location = 5) out flat uint outHeightTex;
layout(location = 6) out flat uint outNormalTex;
layout(location = 7) out mat4 outModel;
